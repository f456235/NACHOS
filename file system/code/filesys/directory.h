...
public:
    ...
    char name[FileNameMaxLen + 1]; // Text name for file, with +1 for
                                   // the trailing '\0'
    /*li3_12*/
    bool isadirectory; // TRUE: is directory , FALSE: is a file.
};
...
public:
    ...
    bool Add(char *name, int newSector, bool isadirectory); // Add a file name into the directory
    ...
    // void Print(); // Verbose print of the contents
                  //  of the directory -- all the file
                  //  names and their contents.
    bool isadirectory(char* pathname){
        // cout << "isadirectory" << endl;
        int entry_index = this->FindIndex(pathname);
        // cout << "entry_index: " << entry_index << endl;
        return this->table[entry_index].isadirectory; 
    };
