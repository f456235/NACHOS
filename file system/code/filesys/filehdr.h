...
/*li2_2*/
#define BYTES_1LEVEL NumDirect*SectorSize // 4kB
#define BYTES_2LEVEL NumDirect*NumDirect*SectorSize // 128 KB
#define BYTES_3LEVEL NumDirect*NumDirect*NumDirect*SectorSize // 3.5 MB 
#define BYTES_4LEVEL NumDirect*NumDirect*NumDirect*NumDirect*SectorSize // 100 MB 
...
public:
	...
	// bool AllocateRecursive(PersistentBitmap *freeMap, int fileSize, int level);
	void AllocateSubHeader(FileHeader* subHeader, PersistentBitmap* freeMap, int& fileSize, int subSize);
	void CleanDiskSector(int sector);
	void PrintRecursive(int levels);
